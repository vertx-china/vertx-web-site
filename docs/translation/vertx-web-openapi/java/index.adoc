...
`link:../../apidocs/io/vertx/ext/web/openapi/RouterBuilder.html[RouterBuilder]` 是这个模块的主要元素：它提供来挂载请求处理器的接口并且生成最终的 `link:../../apidocs/io/vertx/ext/web/Router.html[Router]`
